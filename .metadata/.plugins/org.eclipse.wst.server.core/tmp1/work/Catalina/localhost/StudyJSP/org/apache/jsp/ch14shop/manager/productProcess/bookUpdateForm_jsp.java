 ...
 * Generated at: 2022-12-28 09:26:25 UTC
...
public final class bookUpdateForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  String bar="#778899";
	...
	try {
      ...
      out.write("			<label for=\"tab-1\" class=\"tab\">책 수정</label>\n");
...
if(book.getBook_kind().equals("300")){
      ...
      out.write("\">\n");
      out.write("							<input id=\"user\" type=\"hidden\" name=\"book_id\" value=\"");
      out.print(book_id);
      out.write("\">\n");
      out.write("						</div>\n");
      out.write("						<div class=\"group\">\n");
...
if(Integer.parseInt(book.getPublishing_date().substring(8)) ==i){
      ...
      out.write("						</div>\n");
      out.write("						<div class=\"group\">\n");
      out.write("							<input class=\"button\" type=\"button\" value=\"책 수정\" onclick=\"updateCheckForm(this.form)\">\n");
      out.write("						</div>\n");
      out.write("						<div class=\"group\">\n");
